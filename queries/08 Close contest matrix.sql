WITH ranked_results AS
  ...
  (SELECT r1.STATE,
   ...
   JOIN ranked_results r2 ON r1.STATE = r2.STATE
...
SELECT STATE,
       LOSING_PARTY,
       COUNT(CASE
                 WHEN VOTE_DIFFERENCE < 500 THEN 1
             END) AS "< 500",
       COUNT(CASE
                 WHEN VOTE_DIFFERENCE < 2500 THEN 1
             END) AS "< 2500",
       COUNT(CASE
                 WHEN VOTE_DIFFERENCE < 5000 THEN 1
             END) AS "< 5000",
       COUNT(CASE
                 WHEN VOTE_DIFFERENCE < 10000 THEN 1
             END) AS "< 10000",
       COUNT(CASE
                 WHEN VOTE_DIFFERENCE < 15000 THEN 1
             END) AS "< 15000",
       COUNT(CASE
                 WHEN VOTE_DIFFERENCE < 25000 THEN 1
             END) AS "< 25000",
       COUNT(CASE
                 WHEN VOTE_DIFFERENCE < 50000 THEN 1
             END) AS "< 50000"
FROM winner_and_runner_up
GROUP BY STATE,
         LOSING_PARTY
HAVING COUNT(CASE
                 WHEN VOTE_DIFFERENCE < 500 THEN 1
