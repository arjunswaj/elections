...
FROM
    ...
    FROM
        INDIA_GENERAL_ELECTIONS.ASSEMBLY_ELECTIONS_FEB2025
...
FROM
    ...
    GROUP BY STATE, CONSTITUENCY) AS VOTE_DETAILS
        JOIN
    ASSEMBLY_ELECTIONS_FEB2025 ger ON VOTE_DETAILS.CONSTITUENCY = ger.CONSTITUENCY
...
FROM
    ...
    FROM
        ...
        FROM
            ASSEMBLY_ELECTIONS_FEB2025
        GROUP BY STATE, CONSTITUENCY) AS VOTE_DETAILS
    JOIN ASSEMBLY_ELECTIONS_FEB2025 ger ON VOTE_DETAILS.CONSTITUENCY = ger.CONSTITUENCY
...
FROM
    ASSEMBLY_ELECTIONS_FEB2025 t2
        JOIN
    (SELECT 
        t.STATE, t.CONSTITUENCY, MAX(t.VOTES) AS RUNNER_VOTES
    FROM
        ASSEMBLY_ELECTIONS_FEB2025 t
    JOIN (SELECT 
        STATE, CONSTITUENCY, MAX(VOTES) AS MAX_VOTES
    FROM
        ASSEMBLY_ELECTIONS_FEB2025
